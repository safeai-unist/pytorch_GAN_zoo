...
class Options():
    def __init__(self):
        ...
        train_arg.add_argument("--dataset", type=str, default="/home/safeai24/safe24/style_docker/pytorch_GAN_zoo/imagenet_mini/imagenet-mini/train/",
                                help="path to training dataset, the path should point to a folder "
                                "containing another folder with all the training images")
        train_arg.add_argument("--style-folder", type=str, default="/home/safeai24/safe24/style_docker/pytorch_GAN_zoo/dtd/images/",
